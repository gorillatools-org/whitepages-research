                    ...
                    while (i2 < value.length()) {
                        ...
                        if (StringsKt.equals(trimSubstring, "permessage-deflate", true)) {
                            ...
                            while (i3 < delimiterOffset$default) {
                                ...
                                String removeSurrounding = delimiterOffset3 < delimiterOffset2 ? StringsKt.removeSurrounding(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2), "\"") : null;
