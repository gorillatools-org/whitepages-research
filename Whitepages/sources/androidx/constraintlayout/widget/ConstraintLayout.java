...
public class ConstraintLayout extends ViewGroup {
            ...
            if (constraintWidget2 != null) {
                if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                    ...
                    if (i12 == 1) {
                        ...
                        int i13 = measure2.measureStrategy;
                        if (i13 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i13 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                            ...
                            if (measure2.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || ((z && z2) || constraintWidget.isResolvedHorizontally())) {
                    ...
                    if (i14 == 1) {
                        ...
                        int i15 = measure2.measureStrategy;
                        if (i15 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i15 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                            ...
                            if (measure2.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || ((z3 && z4) || constraintWidget.isResolvedVertically())) {
                    ...
                    if (constraintWidgetContainer == null || !Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 256) || view.getMeasuredWidth() != constraintWidget.getWidth() || view.getMeasuredWidth() >= constraintWidgetContainer.getWidth() || view.getMeasuredHeight() != constraintWidget.getHeight() || view.getMeasuredHeight() >= constraintWidgetContainer.getHeight() || view.getBaseline() != constraintWidget.getBaselineDistance() || constraintWidget.isMeasureRequested() || !isSimilarSpec(constraintWidget.getLastHorizontalMeasureSpec(), i, constraintWidget.getWidth()) || !isSimilarSpec(constraintWidget.getLastVerticalMeasureSpec(), i2, constraintWidget.getHeight())) {
                        ...
                        if (view != null) {
                            ...
                            if (i16 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i16 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z5 || constraintWidget2.mMatchConstraintDefaultWidth != 0 || !z6 || constraintWidget2.mMatchConstraintDefaultHeight != 0) {
                                view.measure(i, i2);
                                constraintWidget2.setLastMeasureSpec(i, i2);
                                int measuredWidth = view.getMeasuredWidth();
                                int measuredHeight = view.getMeasuredHeight();
                                i4 = view.getBaseline();
                                int i17 = constraintWidget2.mMatchConstraintMinWidth;
                                i3 = i17 > 0 ? Math.max(i17, measuredWidth) : measuredWidth;
                                int i18 = constraintWidget2.mMatchConstraintMaxWidth;
                                if (i18 > 0) {
                                    i3 = Math.min(i18, i3);
                                }
                                int i19 = constraintWidget2.mMatchConstraintMinHeight;
                                if (i19 > 0) {
                                ...
                                int i20 = constraintWidget2.mMatchConstraintMaxHeight;
                                if (i20 > 0) {
                                    i5 = Math.min(i20, i5);
                                }
                                ...
                                if (!(measuredWidth == i3 && measuredHeight == i5)) {
                                    ...
                                    constraintWidget2.setLastMeasureSpec(makeMeasureSpec, i2);
                            ...
                            boolean z11 = i4 != i6;
                            measure2.measuredNeedsSolverPass = (i3 == measure2.horizontalDimension && i5 == measure2.verticalDimension) ? false : true;
                            if (layoutParams.needsBaseline) {
                                z11 = true;
                            }
                            if (!(!z11 || i4 == -1 || constraintWidget.getBaselineDistance() == i4)) {
                                measure2.measuredNeedsSolverPass = true;
                            }
                            measure2.measuredWidth = i3;
                            measure2.measuredHeight = i5;
                            measure2.measuredHasBaseline = z11;
    ...
    private void setChildrenConstraints() {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (viewWidget2 != null) {
                ...
                applyConstraintsFromLayoutParams(isInEditMode, childAt3, viewWidget2, (LayoutParams) childAt3.getLayoutParams(), this.mTempMapIdToWidget);
            }
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        int resolveGoneLeftMargin = ExploreByTouchHelper.INVALID_ID;
        int resolveGoneRightMargin = ExploreByTouchHelper.INVALID_ID;
