...
public class ProfileInstallerInitializer implements Initializer {
    ...
    public void delayAfterFirstFrame(Context context) {
        Choreographer16Impl.postFrameCallback(new ProfileInstallerInitializer$$ExternalSyntheticLambda0(this, context));
    }
    ...
    public void lambda$delayAfterFirstFrame$0(Context context) {
        ...
        handler.postDelayed(new ProfileInstallerInitializer$$ExternalSyntheticLambda1(context), (long) (new Random().nextInt(Math.max(1000, 1)) + 5000));
    }
