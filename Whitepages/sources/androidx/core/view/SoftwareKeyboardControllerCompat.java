    ...
    private static class Impl30 extends Impl20 {
        ...
        public void hide() {
            ...
            if (windowInsetsController != null) {
                ...
                SoftwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda6 softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda6 = new SoftwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda6(atomicBoolean);
                windowInsetsController.addOnControllableInsetsChangedListener(softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda6);
                if (!atomicBoolean.get() && (view = this.mView) != null) {
                    ((InputMethodManager) view.getContext().getSystemService("input_method")).hideSoftInputFromWindow(this.mView.getWindowToken(), 0);
                }
                windowInsetsController.removeOnControllableInsetsChangedListener(softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda6);
