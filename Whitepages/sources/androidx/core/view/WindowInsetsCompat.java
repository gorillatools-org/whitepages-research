...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowInsetsCompat$BuilderImpl29$$ExternalSyntheticApiModelOutline7.m();
        }
        ...
        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builder = WindowInsetsCompat$BuilderImpl29$$ExternalSyntheticApiModelOutline6.m(windowInsets);
            } else {
                builder = WindowInsetsCompat$BuilderImpl29$$ExternalSyntheticApiModelOutline7.m();
            }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        /* access modifiers changed from: package-private */
        public void setInsets(int i, Insets insets) {
            WindowInsets.Builder unused = this.mPlatBuilder.setInsets(TypeImpl30.toPlatformType(i), insets.toPlatformInsets());
        }
    }
    ...
    private static final class TypeImpl30 {
        static int toPlatformType(int i) {
            ...
            for (int i3 = 1; i3 <= 256; i3 <<= 1) {
                if ((i & i3) != 0) {
                    if (i3 == 1) {
                        m = WindowInsets.Type.statusBars();
                    } else if (i3 == 2) {
                        m = WindowInsets.Type.navigationBars();
                    } else if (i3 == 4) {
                        m = WindowInsets.Type.captionBar();
                    } else if (i3 == 8) {
                        m = WindowInsets.Type.ime();
                    } else if (i3 == 16) {
                        m = WindowInsets.Type.systemGestures();
                    } else if (i3 == 32) {
                        m = WindowInsets.Type.mandatorySystemGestures();
                    } else if (i3 == 64) {
                        m = WindowInsets.Type.tappableElement();
                    } else if (i3 == 128) {
                        m = WindowInsets.Type.displayCutout();
                    }
                    i2 |= m;
                }
            }
