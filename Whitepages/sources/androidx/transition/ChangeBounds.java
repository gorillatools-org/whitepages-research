...
public class ChangeBounds extends Transition {
    ...
    static {
        ...
        DRAWABLE_ORIGIN_PROPERTY = new Property(cls, "boundsOrigin") {
        ...
        TOP_LEFT_PROPERTY = new Property(cls, "topLeft") {
        ...
        BOTTOM_RIGHT_PROPERTY = new Property(cls, "bottomRight") {
            public PointF get(ViewBounds viewBounds) {
                return null;
            }
        ...
        BOTTOM_RIGHT_ONLY_PROPERTY = new Property(cls, "bottomRight") {
        ...
        TOP_LEFT_ONLY_PROPERTY = new Property(cls, "topLeft") {
            public PointF get(View view) {
                return null;
            }
        ...
        POSITION_PROPERTY = new Property(cls, ViewProps.POSITION) {
            public PointF get(View view) {
                return null;
            }
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (!this.mResizeClip) {
                ...
                if (!rect3.equals(rect6)) {
                    ...
                    ObjectAnimator ofObject = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, new Object[]{rect3, rect6});
                    ...
                    ofObject.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animator) {
                            if (!this.mIsCanceled) {
                                ViewCompat.setClipBounds(view4, rect7);
                                ViewUtils.setLeftTopRightBottom(view4, i15, i16, i18, i17);
                            }
                        }
                    });
        ...
        int i19 = iArr[0];
        int i20 = iArr[1];
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, new PropertyValuesHolder[]{PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, pathMotion.getPath((float) (intValue - i19), (float) (intValue2 - i20), (float) (intValue3 - i19), (float) (intValue4 - i20)))});
