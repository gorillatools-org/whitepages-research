...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    int mPendingScrollPositionOffset = ExploreByTouchHelper.INVALID_ID;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            for (int i4 = 0; i4 < this.mSpanCount; i4++) {
                if (this.mLastLayoutFromEnd) {
                    i2 = this.mSpans[i4].getEndLine(ExploreByTouchHelper.INVALID_ID);
                    ...
                    i2 = this.mSpans[i4].getStartLine(ExploreByTouchHelper.INVALID_ID);
                    if (i2 != Integer.MIN_VALUE) {
                        startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
                    } else {
                        savedState.mSpanOffsets[i4] = i2;
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            ...
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanIndex, i, -1, -1, false, false));
            return;
        }
    ...
    private void fixEndGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z) {
        int endAfterPadding;
        int maxEnd = getMaxEnd(ExploreByTouchHelper.INVALID_ID);
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            i = layoutState2.mLayoutDirection == 1 ? Integer.MAX_VALUE : ExploreByTouchHelper.INVALID_ID;
        ...
        int i11 = i;
        updateAllRemainingSpans(layoutState2.mLayoutDirection, i11);
        if (this.mShouldReverseLayout) {
            startAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        } else {
            startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        ...
        return i2 > 0 ? Math.min(layoutState2.mAvailable, i2) : i13;
    }
    ...
    public boolean areAllEndsEqual() {
        int endLine = this.mSpans[0].getEndLine(ExploreByTouchHelper.INVALID_ID);
        for (int i = 1; i < this.mSpanCount; i++) {
            if (this.mSpans[i].getEndLine(ExploreByTouchHelper.INVALID_ID) != endLine) {
                return false;
            }
        }
        return true;
    ...
    public boolean areAllStartsEqual() {
        int startLine = this.mSpans[0].getStartLine(ExploreByTouchHelper.INVALID_ID);
        for (int i = 1; i < this.mSpanCount; i++) {
            if (this.mSpans[i].getStartLine(ExploreByTouchHelper.INVALID_ID) != startLine) {
                return false;
            }
        }
        return true;
    ...
    class Span {
        int mCachedEnd = ExploreByTouchHelper.INVALID_ID;
        int mCachedStart = ExploreByTouchHelper.INVALID_ID;
        int mDeletedSize = 0;
        final int mIndex;
        ...
        public void prependToSpan(View view) {
            ...
            this.mCachedStart = ExploreByTouchHelper.INVALID_ID;
            if (this.mViews.size() == 1) {
                this.mCachedEnd = ExploreByTouchHelper.INVALID_ID;
            }
        ...
        public void cacheReferenceLineAndClear(boolean z, int i) {
            int i2;
            if (z) {
                i2 = getEndLine(ExploreByTouchHelper.INVALID_ID);
            } else {
                i2 = getStartLine(ExploreByTouchHelper.INVALID_ID);
            }
            clear();
            if (i2 != Integer.MIN_VALUE) {
    ...
    static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i) {
            ...
            return ((FullSpanItem) this.mFullSpanItems.get(i2)).mPosition;
        }
    ...
    class AnchorInfo {
        ...
        public void saveSpanReferenceLines(Span[] spanArr) {
            ...
            for (int i = 0; i < length; i++) {
                this.mSpanReferenceLines[i] = spanArr[i].getStartLine(ExploreByTouchHelper.INVALID_ID);
            }
        }
