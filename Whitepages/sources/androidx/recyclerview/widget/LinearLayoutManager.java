...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean updateAnchorFromChildren(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (focusedChild != null && anchorInfo.isViewValidAsAnchor(focusedChild, state)) {
            ...
            if (!state.isPreLayout() && supportsPredictiveItemAnimations() && (this.mOrientationHelper.getDecoratedStart(view) >= this.mOrientationHelper.getEndAfterPadding() || this.mOrientationHelper.getDecoratedEnd(view) < this.mOrientationHelper.getStartAfterPadding())) {
                if (anchorInfo.mLayoutFromEnd) {
    ...
    private void updateLayoutStateToFillEnd(int i, int i2) {
        ...
        layoutState.mScrollingOffset = ExploreByTouchHelper.INVALID_ID;
    }
    ...
    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.State state) {
        ...
        if (z) {
            layoutState6.mAvailable = i2 - i3;
        }
        layoutState6.mScrollingOffset = i3;
    }
    ...
    static class AnchorInfo {
        ...
        public void reset() {
            this.mPosition = -1;
            this.mCoordinate = ExploreByTouchHelper.INVALID_ID;
