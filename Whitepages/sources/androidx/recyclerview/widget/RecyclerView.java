...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public void smoothScrollBy(int i, int i2, Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, ExploreByTouchHelper.INVALID_ID);
    }
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (int i2 = 0; i2 < this.mChildHelper.getChildCount(); i2++) {
                ...
                if (!childViewHolderInt2.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(childViewHolderInt2)) {
                    ...
                    if (!hasAnyOfTheFlags) {
                        buildAdapterChangeFlagsForAnimations |= b.v;
                    }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int i, int i2) {
            ...
            this.mOverScroller.fling(0, 0, i, i2, ExploreByTouchHelper.INVALID_ID, Integer.MAX_VALUE, ExploreByTouchHelper.INVALID_ID, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            return Math.min(i5, Constants.MAX_URL_LENGTH);
        }
    ...
    public void dispatchChildDetached(View view) {
        ...
        if (list != null && list.size() - 1 >= 0) {
            MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(this.mOnChildAttachStateListeners.get(size));
            throw null;
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (this.mRecyclerView.canScrollVertically(-1) || this.mRecyclerView.canScrollHorizontally(-1)) {
                accessibilityNodeInfoCompat.addAction((int) UserMetadata.MAX_INTERNAL_KEY_SIZE);
                accessibilityNodeInfoCompat.setScrollable(true);
            }
            if (this.mRecyclerView.canScrollVertically(1) || this.mRecyclerView.canScrollHorizontally(1)) {
                accessibilityNodeInfoCompat.addAction((int) b.v);
                accessibilityNodeInfoCompat.setScrollable(true);
            }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(int i, int i2) {
                this(i, i2, ExploreByTouchHelper.INVALID_ID, (Interpolator) null);
            }
    ...
    public static abstract class ItemAnimator {
        ...
        static int buildAdapterChangeFlagsForAnimations(ViewHolder viewHolder) {
            ...
            return (oldPosition == -1 || adapterPosition == -1 || oldPosition == adapterPosition) ? i2 : i2 | b.u;
        }
