...
final class EmojiInputFilter implements InputFilter {
    ...
    private static class InitCallbackImpl extends EmojiCompat.InitCallback {
        ...
        public void onInitialized() {
            ...
            if (isInputFilterCurrentlyRegisteredOnTextView(textView, (InputFilter) this.mEmojiInputFilterReference.get()) && textView.isAttachedToWindow() && (text = textView.getText()) != (process = EmojiCompat.get().process(text))) {
