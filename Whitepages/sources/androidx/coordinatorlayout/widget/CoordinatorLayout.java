...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final Comparator TOP_SORTED_CHILDREN_COMPARATOR = new ViewElevationComparator();
    static final String WIDGET_PACKAGE_NAME;
    static final ThreadLocal sConstructors = new ThreadLocal();
    private static final Pools$Pool sRectPool = new Pools$SynchronizedPool(12);
    ...
    public void onMeasure(int r31, int r32) {
        ...
        L_0x004b:
            r19 = 0
        L_0x004d:
            java.util.List r2 = r7.mDependencySortedChildren
            int r6 = r2.size()
            r5 = r0
            r4 = r1
            r2 = 0
