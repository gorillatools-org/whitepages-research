...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - NetworkManager.MAX_SERVER_RETRY, location.getLatitude(), location.getLongitude());
        ...
        long j4 = j3;
        long j5 = j2;
        instance.calculateTwilight(currentTimeMillis + NetworkManager.MAX_SERVER_RETRY, location.getLatitude(), location.getLongitude());
