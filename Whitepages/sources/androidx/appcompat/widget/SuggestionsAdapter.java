...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r7) {
        /*
            ...
            android.graphics.drawable.Drawable r7 = r6.getDrawableFromResourceUri(r7)     // Catch:{ NotFoundException -> 0x0018 }
            return r7
        L_0x0016:
            r0 = move-exception
            goto L_0x0087
        ...
        L_0x002f:
            android.content.Context r3 = r6.mProviderContext     // Catch:{ FileNotFoundException -> 0x0016 }
    ...
    private Drawable getActivityIconWithCache(ComponentName componentName) {
        ...
        if (this.mOutsideDrawablesCache.containsKey(flattenToShortString)) {
            Drawable.ConstantState constantState2 = (Drawable.ConstantState) this.mOutsideDrawablesCache.get(flattenToShortString);
