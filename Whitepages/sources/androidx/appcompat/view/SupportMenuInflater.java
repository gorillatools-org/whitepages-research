...
public class SupportMenuInflater extends MenuInflater {
    ...
    public void inflate(int i, Menu menu) {
        ...
        try {
            ...
            parseMenu(layout, asAttributeSet, menu);
            if (z) {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (obtainStyledAttributes.getInt(R$styleable.MenuItem_android_menuCategory, this.groupCategory) & -65536) | (obtainStyledAttributes.getInt(R$styleable.MenuItem_android_orderInCategory, this.groupOrder) & Settings.DEFAULT_INITIAL_WINDOW_SIZE);
            ...
            this.itemAlphabeticModifiers = obtainStyledAttributes.getInt(R$styleable.MenuItem_alphabeticModifiers, b.v);
            this.itemNumericShortcut = getShortcut(obtainStyledAttributes.getString(R$styleable.MenuItem_android_numericShortcut));
            this.itemNumericModifiers = obtainStyledAttributes.getInt(R$styleable.MenuItem_numericModifiers, b.v);
