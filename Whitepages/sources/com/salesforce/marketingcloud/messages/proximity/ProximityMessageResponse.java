...
public final class ProximityMessageResponse implements MessageResponse {
    ...
    public ProximityMessageResponse(LatLon latLon, int i, List<Region> list) {
        ...
        Intrinsics.checkNotNullParameter(list, "beacons");
