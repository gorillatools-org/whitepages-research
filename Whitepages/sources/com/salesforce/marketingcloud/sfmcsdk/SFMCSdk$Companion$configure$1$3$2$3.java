...
final class SFMCSdk$Companion$configure$1$3$2$3 extends Lambda implements Function0 {
    ...
    public final void invoke() {
        ...
        pushModule$sfmcsdk_release.initModule(context, config, this.$components, new SFMCSdk$Companion$configure$1$3$2$3$$ExternalSyntheticLambda0(this.$moduleInitLatch, config));
    }

    /* access modifiers changed from: private */
    /* renamed from: invoke$lambda-1  reason: not valid java name */
    public static final void m808invoke$lambda1(CountDownLatch countDownLatch, Config config, ModuleInterface moduleInterface) {
