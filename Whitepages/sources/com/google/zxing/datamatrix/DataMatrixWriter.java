...
public final class DataMatrixWriter implements Writer {
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map map) {
        if (str.isEmpty()) {
            ...
            String encodeHighLevel = HighLevelEncoder.encodeHighLevel(str, symbolShapeHint, (Dimension) null, (Dimension) null);
            SymbolInfo lookup = SymbolInfo.lookup(encodeHighLevel.length(), symbolShapeHint, (Dimension) null, (Dimension) null, true);
