...
abstract class ArrayDecoders {
    ...
    static int decodeString(byte[] bArr, int i, Registers registers) {
    ...
    static int decodeStringRequireUtf8(byte[] bArr, int i, Registers registers) {
        int decodeVarint32 = decodeVarint32(bArr, i, registers);
        int i2 = registers.int1;
        if (i2 < 0) {
            throw InvalidProtocolBufferException.negativeSize();
    ...
    static int decodeBytes(byte[] bArr, int i, Registers registers) {
        int decodeVarint32 = decodeVarint32(bArr, i, registers);
        int i2 = registers.int1;
        if (i2 < 0) {
            throw InvalidProtocolBufferException.negativeSize();
    ...
    static int decodeMessageField(Schema schema, byte[] bArr, int i, int i2, Registers registers) {
    ...
    static int mergeMessageField(java.lang.Object r6, com.google.protobuf.Schema r7, byte[] r8, int r9, int r10, com.google.protobuf.ArrayDecoders.Registers r11) {
        /*
            int r0 = r9 + 1
            byte r9 = r8[r9]
    ...
    static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i, int i2, int i3, Registers registers) {
    ...
    static int decodeStringList(int r4, byte[] r5, int r6, int r7, com.google.protobuf.Internal.ProtobufList r8, com.google.protobuf.ArrayDecoders.Registers r9) {
        /*
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int decodeStringListRequireUtf8(int r5, byte[] r6, int r7, int r8, com.google.protobuf.Internal.ProtobufList r9, com.google.protobuf.ArrayDecoders.Registers r10) {
        /*
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int decodeBytesList(int r2, byte[] r3, int r4, int r5, com.google.protobuf.Internal.ProtobufList r6, com.google.protobuf.ArrayDecoders.Registers r7) {
        /*
    ...
    static int decodeMessageList(Schema schema, int i, byte[] bArr, int i2, int i3, Internal.ProtobufList protobufList, Registers registers) {
    ...
    static int decodeGroupList(Schema schema, int i, byte[] bArr, int i2, int i3, Internal.ProtobufList protobufList, Registers registers) {
        int i4 = (i & -8) | 4;
    ...
    static int decodeExtensionOrUnknownField(int i, byte[] bArr, int i2, int i3, Object obj, MessageLite messageLite, UnknownFieldSchema unknownFieldSchema, Registers registers) {
    ...
    static int decodeUnknownField(int i, byte[] bArr, int i2, int i3, UnknownFieldSetLite unknownFieldSetLite, Registers registers) {
