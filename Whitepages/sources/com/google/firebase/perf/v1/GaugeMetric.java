...
public final class GaugeMetric extends GeneratedMessageLite implements GaugeMetricOrBuilder {
    ...
    private Internal.ProtobufList androidMemoryReadings_ = GeneratedMessageLite.emptyProtobufList();
    private int bitField0_;
    private Internal.ProtobufList cpuMetricReadings_ = GeneratedMessageLite.emptyProtobufList();
    ...
    private void ensureCpuMetricReadingsIsMutable() {
        Internal.ProtobufList protobufList = this.cpuMetricReadings_;
    ...
    private void ensureAndroidMemoryReadingsIsMutable() {
        Internal.ProtobufList protobufList = this.androidMemoryReadings_;
        if (!protobufList.isModifiable()) {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder implements GaugeMetricOrBuilder {
