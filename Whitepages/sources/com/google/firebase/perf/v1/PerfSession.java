...
public final class PerfSession extends GeneratedMessageLite implements PerfSessionOrBuilder {
    /* access modifiers changed from: private */
    public static final PerfSession DEFAULT_INSTANCE;
    private static volatile Parser PARSER = null;
    public static final int SESSION_ID_FIELD_NUMBER = 1;
    public static final int SESSION_VERBOSITY_FIELD_NUMBER = 2;
    private static final Internal.ListAdapter.Converter sessionVerbosity_converter_ = new Internal.ListAdapter.Converter() {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder implements PerfSessionOrBuilder {
        private Builder() {
