...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda0(this, j, hashMap));
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda3(this, hashMap));
    }
    ...
    public Task<FetchResponse> lambda$fetch$0(Task<ConfigContainer> task, long j, Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda1(this, id, token, date, map));
        }
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date, Map<String, String> map) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda4(fetchFromBackend));
    ...
    private FetchResponse fetchFromBackend(String str, String str2, Date date, Map<String, String> map) throws FirebaseRemoteConfigException {
        try {
            ...
            ConfigSharedPrefsClient.BackoffMetadata updateAndReturnBackoffMetadata = updateAndReturnBackoffMetadata(e.getHttpStatusCode(), date);
