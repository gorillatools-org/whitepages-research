...
public final /* synthetic */ class ConfigFetchHandler$$ExternalSyntheticLambda1 implements Continuation {
    ...
    public /* synthetic */ ConfigFetchHandler$$ExternalSyntheticLambda1(ConfigFetchHandler configFetchHandler, Task task, Task task2, Date date, Map map) {
    ...
    public final Object then(Task task) {
        return this.f$0.lambda$fetchIfCacheExpiredAndNotThrottled$2(this.f$1, this.f$2, this.f$3, this.f$4, task);
    }
}
