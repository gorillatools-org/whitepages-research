        ...
        public static ArrayMap extractDeveloperDefinedPayload(Bundle bundle) {
            ...
            for (String next : bundle.keySet()) {
                ...
                if (obj instanceof String) {
                    ...
                    if (!next.startsWith(RESERVED_PREFIX) && !next.startsWith(MessageNotificationKeys.RESERVED_PREFIX) && !next.equals(FROM) && !next.equals("message_type") && !next.equals(COLLAPSE_KEY)) {
