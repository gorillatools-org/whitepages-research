...
final class ProxyNotificationInitializer {
    ...
    static Task<Void> setEnableProxyNotification(Executor executor, Context context, boolean z) {
        ...
        executor.execute(new ProxyNotificationInitializer$$ExternalSyntheticLambda2(context, z, taskCompletionSource));
    ...
    static void initialize(Context context) {
        if (!ProxyNotificationPreferences.isProxyNotificationInitialized(context)) {
            setEnableProxyNotification(new MeasurementManagerImplCommon$$ExternalSyntheticLambda3(), context, shouldEnableProxyNotification(context));
        }
    }
