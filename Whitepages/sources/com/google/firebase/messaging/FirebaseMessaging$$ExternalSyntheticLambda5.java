...
public final /* synthetic */ class FirebaseMessaging$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda5(FirebaseMessaging firebaseMessaging, TaskCompletionSource taskCompletionSource) {
        this.f$0 = firebaseMessaging;
        this.f$1 = taskCompletionSource;
    }

    public final void run() {
        this.f$0.lambda$getToken$7(this.f$1);
    }
}
