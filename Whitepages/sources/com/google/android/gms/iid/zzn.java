...
final class zzn {
    ...
    private static void zzd(android.content.Context r4, java.lang.String r5, com.google.android.gms.iid.zzo r6) {
        /*
            ...
            r1 = 3
            boolean r1 = android.util.Log.isLoggable(r0, r1)     // Catch:{ IOException -> 0x000f }
            if (r1 == 0) goto L_0x0011
            java.lang.String r1 = "Writing key to properties file"
            android.util.Log.d(r0, r1)     // Catch:{ IOException -> 0x000f }
            goto L_0x0011
        L_0x000f:
            r4 = move-exception
            goto L_0x0050
        L_0x0011:
            java.io.File r4 = zzj(r4, r5)     // Catch:{ IOException -> 0x000f }
            r4.createNewFile()     // Catch:{ IOException -> 0x000f }
            java.util.Properties r5 = new java.util.Properties     // Catch:{ IOException -> 0x000f }
            r5.<init>()     // Catch:{ IOException -> 0x000f }
            java.lang.String r1 = "pub"
            java.lang.String r2 = r6.zzq()     // Catch:{ IOException -> 0x000f }
            r5.setProperty(r1, r2)     // Catch:{ IOException -> 0x000f }
            java.lang.String r1 = "pri"
            java.lang.String r2 = r6.zzr()     // Catch:{ IOException -> 0x000f }
            r5.setProperty(r1, r2)     // Catch:{ IOException -> 0x000f }
            java.lang.String r1 = "cre"
            long r2 = r6.zzcc     // Catch:{ IOException -> 0x000f }
            java.lang.String r6 = java.lang.String.valueOf(r2)     // Catch:{ IOException -> 0x000f }
            r5.setProperty(r1, r6)     // Catch:{ IOException -> 0x000f }
            java.io.FileOutputStream r6 = new java.io.FileOutputStream     // Catch:{ IOException -> 0x000f }
            r6.<init>(r4)     // Catch:{ IOException -> 0x000f }
            r4 = 0
            r5.store(r6, r4)     // Catch:{ all -> 0x0049 }
            zzd((java.lang.Throwable) r4, (java.io.FileOutputStream) r6)     // Catch:{ IOException -> 0x000f }
            return
        L_0x0049:
            r4 = move-exception
        ...
        L_0x004b:
            r5 = move-exception
            zzd((java.lang.Throwable) r4, (java.io.FileOutputStream) r6)     // Catch:{ IOException -> 0x000f }
            throw r5     // Catch:{ IOException -> 0x000f }
        L_0x0050:
