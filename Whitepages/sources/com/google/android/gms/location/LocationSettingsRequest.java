...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    LocationSettingsRequest(@SafeParcelable.Param(id = 1) List<LocationRequest> list, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) boolean z2, @SafeParcelable.Param(id = 5) zzbj zzbj) {
        this.zza = list;
        this.zzb = z;
        this.zzc = z2;
        this.zzd = zzbj;
