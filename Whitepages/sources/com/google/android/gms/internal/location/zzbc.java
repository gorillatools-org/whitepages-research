...
public final class zzbc extends AbstractSafeParcelable {
    ...
    zzbc(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) zzba zzba, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(id = 5) IBinder iBinder2, @SafeParcelable.Param(id = 6) IBinder iBinder3) {
        zzbd zzbd;
        zzba zzba2;
        this.zza = i;
        this.zzb = zzba;
