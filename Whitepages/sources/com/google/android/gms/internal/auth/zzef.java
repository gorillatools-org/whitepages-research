...
public abstract class zzef implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", new Object[]{Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzd()), zzd() <= 50 ? zzgx.zza(this) : zzgx.zza(zzf(0, 47)).concat("...")});
    }
