...
final class zzem extends zzba implements RandomAccess {
    private static final zzem zza = new zzem(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzcz zzd(int i) {
        if (i >= this.zzc) {
            return new zzem(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzem(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
