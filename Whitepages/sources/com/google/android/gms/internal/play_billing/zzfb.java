...
class zzfb extends AbstractMap {
    ...
    /* synthetic */ zzfb(int i, zzfa zzfa) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzez(this, (zzey) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzfb.zzb()) {
            return entrySet().equals(zzfb.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzfb.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzfb.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzev zzev = (zzev) this.zzb.remove(i2 - 1);
            zzm().put(zzev.zza(), zzev.getValue());
        }
