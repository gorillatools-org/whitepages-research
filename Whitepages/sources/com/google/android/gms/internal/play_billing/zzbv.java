...
final class zzbv extends zzby {
    ...
    public final void zze(int i, zzbq zzbq) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzbq.zzd());
        zzbq.zzh(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 == zzw) {
                int i2 = i + zzw2;
                this.zzd = i2;
                int zzb2 = zzfu.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb2 - i) - zzw2);
                this.zzd = zzb2;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzfu.zzb(str, bArr, i3, this.zzc - i3);
        } catch (zzft e) {
            this.zzd = i;
            zzA(str, e);
        ...
        if (!zzby.zzc || this.zzc - this.zzd < 10) {
            ...
            while (true) {
                ...
                if ((j & -128) == 0) {
                    ...
                    int i4 = this.zzd;
                    this.zzd = i4 + 1;
                    zzfp.zzn(bArr3, (long) i4, (byte) i3);
                    return;
                }
                byte[] bArr4 = this.zzb;
                int i5 = this.zzd;
                this.zzd = i5 + 1;
                zzfp.zzn(bArr4, (long) i5, (byte) ((i3 | 128) & 255));
                j >>>= 7;
            }
        }
    }
