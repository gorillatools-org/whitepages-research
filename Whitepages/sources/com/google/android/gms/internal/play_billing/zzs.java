...
public interface zzs extends IInterface {
    ...
    void zzq(int i, String str, Bundle bundle, zzl zzl) throws RemoteException;

    void zzr(int i, String str, Bundle bundle, zzn zzn) throws RemoteException;

    void zzs(int i, String str, Bundle bundle, zzp zzp) throws RemoteException;

    void zzt(int i, String str, Bundle bundle, zzu zzu) throws RemoteException;
