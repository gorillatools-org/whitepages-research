...
class zzoa extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int compareTo = comparable.compareTo(((zznw) this.zza[i2]).zza());
            if (compareTo > 0) {
                return -(i + 1);
            }
            if (compareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int compareTo2 = comparable.compareTo(((zznw) this.zza[i4]).zza());
            if (compareTo2 < 0) {
                i2 = i4 - 1;
    ...
    public final Object zzm(int i) {
        zzo();
        Object value = ((zznw) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zznw(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i] = new zznw(this, comparable, obj);
        this.zzb++;
        return null;
    }
