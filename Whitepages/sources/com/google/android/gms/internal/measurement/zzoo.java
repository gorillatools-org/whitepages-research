...
final class zzoo {
    ...
    static int zzb(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x0101:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzoo.zzb(java.lang.String, byte[], int, int):int");
    }
    ...
    static boolean zzd(byte[] r6, int r7, int r8) {
        ...
        L_0x007a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzoo.zzd(byte[], int, int):boolean");
    }
}
