...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior {
    ...
    private int getChildMeasureSpec(int i, int i2, int i3, int i4) {
        ...
        return View.MeasureSpec.makeMeasureSpec(i3, ExploreByTouchHelper.INVALID_ID);
    }
    ...
    public boolean onInterceptTouchEvent(androidx.coordinatorlayout.widget.CoordinatorLayout r10, android.view.View r11, android.view.MotionEvent r12) {
        ...
        L_0x006e:
            ...
            int r5 = r9.initialY
            boolean r11 = r10.isPointInChildBounds(r11, r6, r5)
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, View view, View view2, float f, float f2) {
        ...
        if (this.state != 3 || super.onNestedPreFling(coordinatorLayout, view, view2, f, f2)) {
            return true;
        }
        return false;
    }
