...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private final AccessibilityManagerCompat.TouchExplorationStateChangeListener touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() {
        public void onTouchExplorationStateChanged(boolean z) {
            ...
            if (textInputLayout != null && (autoCompleteTextView = (AutoCompleteTextView) textInputLayout.getEditText()) != null && !DropdownMenuEndIconDelegate.isEditable(autoCompleteTextView)) {
    ...
    public void initialize() {
        ...
        if (i == 0) {
            i = IS_LOLLIPOP ? R$drawable.mtrl_dropdown_arrow : R$drawable.mtrl_ic_arrow_drop_down;
        }
