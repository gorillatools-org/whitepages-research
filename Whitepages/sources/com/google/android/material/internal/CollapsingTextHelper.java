...
public final class CollapsingTextHelper {
    ...
    private float getCollapsedTextLeftBound(int i, int i2) {
        ...
        return ((i2 & 8388613) == 8388613 || (i2 & 5) == 5) ? this.isRtl ? (float) this.collapsedBounds.left : ((float) this.collapsedBounds.right) - this.collapsedTextWidth : this.isRtl ? ((float) this.collapsedBounds.right) - this.collapsedTextWidth : (float) this.collapsedBounds.left;
    }
    ...
    private float getCollapsedTextRightBound(RectF rectF, int i, int i2) {
        ...
        return ((i2 & 8388613) == 8388613 || (i2 & 5) == 5) ? this.isRtl ? rectF.left + this.collapsedTextWidth : (float) this.collapsedBounds.right : this.isRtl ? (float) this.collapsedBounds.right : rectF.left + this.collapsedTextWidth;
    }
    ...
    private void calculateUsingTextSize(float f, boolean z) {
        ...
        if (this.text != null) {
            ...
            if (width > 0.0f) {
                z2 = ((this.currentTextSize > f3 ? 1 : (this.currentTextSize == f3 ? 0 : -1)) != 0) || ((this.currentLetterSpacing > f2 ? 1 : (this.currentLetterSpacing == f2 ? 0 : -1)) != 0) || this.boundsChanged || z2;
