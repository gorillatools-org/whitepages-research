...
public interface ScalingUtils$ScaleType {
    ...
    public static final ScalingUtils$ScaleType FIT_BOTTOM_START = ScalingUtils$ScaleTypeFitBottomStart.INSTANCE;
    ...
    public static final ScalingUtils$ScaleType FIT_X = ScalingUtils$ScaleTypeFitX.INSTANCE;
    public static final ScalingUtils$ScaleType FIT_XY = ScalingUtils$ScaleTypeFitXY.INSTANCE;
    public static final ScalingUtils$ScaleType FIT_Y = ScalingUtils$ScaleTypeFitY.INSTANCE;
