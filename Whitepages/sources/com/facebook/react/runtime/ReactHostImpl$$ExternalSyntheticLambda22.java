...
public final /* synthetic */ class ReactHostImpl$$ExternalSyntheticLambda22 implements Continuation {
    ...
    public /* synthetic */ ReactHostImpl$$ExternalSyntheticLambda22(ReactHostImpl reactHostImpl, ReactHostImpl.ReactInstanceTaskUnwrapper reactInstanceTaskUnwrapper) {
        this.f$0 = reactHostImpl;
        this.f$1 = reactInstanceTaskUnwrapper;
    }

    public final Object then(Task task) {
        return this.f$0.lambda$getOrCreateReloadTask$32(this.f$1, task);
    }
}
