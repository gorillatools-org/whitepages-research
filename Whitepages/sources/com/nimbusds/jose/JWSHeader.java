...
public final class JWSHeader extends CommonSEHeader {
    ...
    public static class Builder {
        ...
        public Builder criticalParams(Set set) {
            this.crit = set;
            return this;
        }
        ...
        public Builder x509CertChain(List list) {
            this.x5c = list;
            return this;
        }
    ...
    public JWSHeader(JWSAlgorithm jWSAlgorithm, JOSEObjectType jOSEObjectType, String str, Set set, URI uri, JWK jwk, URI uri2, Base64URL base64URL, Base64URL base64URL2, List list, String str2, Map map, Base64URL base64URL3) {
    ...
    public static JWSHeader parse(JSONObject jSONObject, Base64URL base64URL) {
    ...
    public static JWSHeader parse(String str, Base64URL base64URL) {
