...
public abstract class Utils {
    ...
    private static final ThreadLocal threadLocalPathMeasure = new ThreadLocal() {
        /* access modifiers changed from: protected */
        public PathMeasure initialValue() {
            return new PathMeasure();
        }
    };
    private static final ThreadLocal threadLocalPoints = new ThreadLocal() {
        /* access modifiers changed from: protected */
        public float[] initialValue() {
            return new float[4];
        }
    };
    private static final ThreadLocal threadLocalTempPath = new ThreadLocal() {
        /* access modifiers changed from: protected */
        public Path initialValue() {
            return new Path();
        }
    };
    private static final ThreadLocal threadLocalTempPath2 = new ThreadLocal() {
        /* access modifiers changed from: protected */
        public Path initialValue() {
            return new Path();
        }
    ...
    public static int mixOpacities(int i, int i2) {
        return (int) ((((((float) i) / 255.0f) * ((float) i2)) / 255.0f) * 255.0f);
    }
