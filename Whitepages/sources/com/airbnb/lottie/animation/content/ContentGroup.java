...
public class ContentGroup implements DrawingContent, PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    private static List contentsFromModels(LottieDrawable lottieDrawable2, LottieComposition lottieComposition, BaseLayer baseLayer, List list) {
        ArrayList arrayList = new ArrayList(list.size());
        for (int i = 0; i < list.size(); i++) {
            Content content = ((ContentModel) list.get(i)).toContent(lottieDrawable2, lottieComposition, baseLayer);
            if (content != null) {
    ...
    ContentGroup(LottieDrawable lottieDrawable2, BaseLayer baseLayer, String str, boolean z, List list, AnimatableTransform animatableTransform) {
