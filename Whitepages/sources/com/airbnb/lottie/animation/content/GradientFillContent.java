...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public GradientFillContent(LottieDrawable lottieDrawable2, LottieComposition lottieComposition, BaseLayer baseLayer, GradientFill gradientFill) {
        Path path2 = new Path();
        this.path = path2;
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        if (!this.hidden) {
            ...
            int intValue = (int) ((((((float) i) / 255.0f) * ((float) ((Integer) this.opacityAnimation.getValue()).intValue())) / 100.0f) * 255.0f);
