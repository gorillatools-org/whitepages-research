...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f = pointF.x;
        float f2 = pointF.y;
        RadialGradient radialGradient2 = new RadialGradient(f, f2, (float) Math.hypot((double) (pointF2.x - f), (double) (pointF2.y - f2)), applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
