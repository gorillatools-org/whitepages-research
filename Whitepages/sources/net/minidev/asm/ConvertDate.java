...
public abstract class ConvertDate {
    static TreeMap daysTable = new TreeMap(new StringCmpNS());
    static TreeMap monthsTable = new TreeMap(new StringCmpNS());
    static TreeMap timeZoneMapping = new TreeMap();
    ...
    private static Integer parseMonth(String str) {
        ...
        Integer num = (Integer) monthsTable.get(str);
        if (num != null) {
            return num;
        }
    ...
    private static void fillMap(TreeMap treeMap, String str, Integer num) {
        treeMap.put(str, num);
    ...
    private static Date getYYYYMMDD(StringTokenizer stringTokenizer, String str) {
        GregorianCalendar gregorianCalendar = new GregorianCalendar(Constants.MAX_URL_LENGTH, 0, 0, 0, 0, 0);
        ...
        return addHour(stringTokenizer, gregorianCalendar, (String) null);
    }

    private static int getYear(String str) {
        int parseInt = Integer.parseInt(str);
        if (parseInt < 100) {
            return parseInt > 23 ? parseInt + Constants.MAX_URL_LENGTH : parseInt + 1900;
        }
        return parseInt;
    }
    ...
    private static String trySkip(StringTokenizer stringTokenizer, String str, Calendar calendar) {
        while (true) {
            TimeZone timeZone = (TimeZone) timeZoneMapping.get(str);
            if (timeZone != null) {
