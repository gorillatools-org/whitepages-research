...
final class ChannelFlow$collect$2 extends SuspendLambda implements Function2 {
    ...
    ChannelFlow$collect$2(FlowCollector flowCollector, ChannelFlow channelFlow, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, produceImpl, (Continuation) this) == coroutine_suspended) {
