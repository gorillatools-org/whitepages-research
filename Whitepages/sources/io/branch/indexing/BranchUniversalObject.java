...
public class BranchUniversalObject implements Parcelable {
    ...
    public void generateShortUrl(Context context, LinkProperties linkProperties, Branch.BranchLinkCreateListener branchLinkCreateListener) {
        if (!TrackingController.isTrackingDisabled(context) || branchLinkCreateListener == null) {
            ...
            branchLinkCreateListener.onLinkCreate(getLinkBuilder(context, linkProperties).getShortUrl(), (BranchError) null);
        }
    }
    ...
    public void showShareSheet(Activity activity, LinkProperties linkProperties, ShareSheetStyle shareSheetStyle, Branch.BranchLinkShareListener branchLinkShareListener, Branch.IChannelProperties iChannelProperties) {
        if (Branch.getInstance() != null) {
            BranchShareSheetBuilder branchShareSheetBuilder = new BranchShareSheetBuilder(activity, getLinkBuilder((Context) activity, linkProperties));
            ...
            branchLinkShareListener.onLinkShareResponse((String) null, (String) null, new BranchError("Trouble sharing link. ", -109));
        } else {
    ...
    public static BranchUniversalObject getReferredBranchUniversalObject() {
        ...
        try {
            ...
            if (instance.getLatestReferringParams().has("+clicked_branch_link") && instance.getLatestReferringParams().getBoolean("+clicked_branch_link")) {
                return createInstance(instance.getLatestReferringParams());
            }
            if (instance.getDeeplinkDebugParams() == null || instance.getDeeplinkDebugParams().length() <= 0) {
                return null;
            }
            return createInstance(instance.getLatestReferringParams());
        } catch (Exception e) {
    ...
    public static io.branch.indexing.BranchUniversalObject createInstance(org.json.JSONObject r5) {
        /*
            r0 = 0
            io.branch.indexing.BranchUniversalObject r1 = new io.branch.indexing.BranchUniversalObject     // Catch:{ Exception -> 0x0100 }
            r1.<init>()     // Catch:{ Exception -> 0x0100 }
            io.branch.referral.BranchUtil$JsonReader r2 = new io.branch.referral.BranchUtil$JsonReader     // Catch:{ Exception -> 0x0065 }
            r2.<init>(r5)     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.ContentTitle     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r2.readOutString(r5)     // Catch:{ Exception -> 0x0065 }
            r1.title_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.CanonicalIdentifier     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r2.readOutString(r5)     // Catch:{ Exception -> 0x0065 }
            r1.canonicalIdentifier_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.CanonicalUrl     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r2.readOutString(r5)     // Catch:{ Exception -> 0x0065 }
            r1.canonicalUrl_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.ContentDesc     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r2.readOutString(r5)     // Catch:{ Exception -> 0x0065 }
            r1.description_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.ContentImgUrl     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r2.readOutString(r5)     // Catch:{ Exception -> 0x0065 }
            r1.imageUrl_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.ContentExpiryTime     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            long r3 = r2.readOutLong(r5)     // Catch:{ Exception -> 0x0065 }
            r1.expirationInMilliSec_ = r3     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.ContentKeyWords     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.Object r5 = r2.readOut(r5)     // Catch:{ Exception -> 0x0065 }
        ...
        L_0x0077:
            ...
            java.util.ArrayList r3 = r1.keywords_     // Catch:{ Exception -> 0x0065 }
            ...
            goto L_0x0077
        L_0x008b:
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.PublicallyIndexable     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            java.lang.Object r5 = r2.readOut(r5)     // Catch:{ Exception -> 0x0065 }
            ...
            io.branch.indexing.BranchUniversalObject$CONTENT_INDEX_MODE r5 = io.branch.indexing.BranchUniversalObject.CONTENT_INDEX_MODE.PUBLIC     // Catch:{ Exception -> 0x0065 }
            goto L_0x00a6
        L_0x00a4:
            io.branch.indexing.BranchUniversalObject$CONTENT_INDEX_MODE r5 = io.branch.indexing.BranchUniversalObject.CONTENT_INDEX_MODE.PRIVATE     // Catch:{ Exception -> 0x0065 }
        L_0x00a6:
            r1.indexMode_ = r5     // Catch:{ Exception -> 0x0065 }
            goto L_0x00bd
        L_0x00a9:
        ...
        L_0x00bb:
            r1.indexMode_ = r5     // Catch:{ Exception -> 0x0065 }
        L_0x00bd:
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.LocallyIndexable     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            boolean r5 = r2.readOutBoolean(r5)     // Catch:{ Exception -> 0x0065 }
        ...
        L_0x00cc:
            io.branch.indexing.BranchUniversalObject$CONTENT_INDEX_MODE r5 = io.branch.indexing.BranchUniversalObject.CONTENT_INDEX_MODE.PRIVATE     // Catch:{ Exception -> 0x0065 }
        L_0x00ce:
            r1.localIndexMode_ = r5     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.Defines$Jsonkey r5 = io.branch.referral.Defines$Jsonkey.CreationTimestamp     // Catch:{ Exception -> 0x0065 }
            java.lang.String r5 = r5.getKey()     // Catch:{ Exception -> 0x0065 }
            long r3 = r2.readOutLong(r5)     // Catch:{ Exception -> 0x0065 }
            r1.creationTimeStamp_ = r3     // Catch:{ Exception -> 0x0065 }
            io.branch.referral.util.ContentMetadata r5 = io.branch.referral.util.ContentMetadata.createFromJson(r2)     // Catch:{ Exception -> 0x0065 }
            r1.metadata_ = r5     // Catch:{ Exception -> 0x0065 }
            org.json.JSONObject r5 = r2.getJsonObject()     // Catch:{ Exception -> 0x0065 }
        ...
        L_0x00ea:
            ...
            io.branch.referral.util.ContentMetadata r3 = r1.metadata_     // Catch:{ Exception -> 0x0065 }
            java.lang.String r4 = r5.optString(r2)     // Catch:{ Exception -> 0x0065 }
            r3.addCustomMetadata(r2, r4)     // Catch:{ Exception -> 0x0065 }
            goto L_0x00ea
        L_0x0100:
            r5 = move-exception
        L_0x0101:
