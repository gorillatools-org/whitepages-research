...
final class InstallReferrersKt$getSamsungGalaxyStoreReferrerDetails$2 extends SuspendLambda implements Function2 {
    final /* synthetic */ Context $context;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InstallReferrersKt$getSamsungGalaxyStoreReferrerDetails$2(Context context, Continuation continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((InstallReferrersKt$getSamsungGalaxyStoreReferrerDetails$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!DependencyUtilsKt.classExists("com.samsung.android.sdk.sinstallreferrer.api.InstallReferrerClient")) {
                return null;
            }
