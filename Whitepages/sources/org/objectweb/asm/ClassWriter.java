...
public class ClassWriter extends ClassVisitor {
    ...
    private Item b(String str) {
        this.h.a(8, str, (String) null, (String) null);
        Item a2 = a(this.h);
        if (a2 != null) {
            return a2;
        }
    ...
    public int a(int i2, int i3) {
        Item item = this.h;
        item.b = 32;
        item.d = ((long) i2) | (((long) i3) << 32);
        item.j = (i2 + 32 + i3) & Integer.MAX_VALUE;
        Item a2 = a(item);
        if (a2 == null) {
            Item[] itemArr = this.H;
            String str = itemArr[i2].g;
            String str2 = itemArr[i3].g;
    ...
    public Item a(Object obj) {
        ...
        if (obj instanceof Type) {
            ...
            return sort == 11 ? c(descriptor) : a(descriptor);
    ...
    public Item a(String str) {
        this.h.a(7, str, (String) null, (String) null);
        Item a2 = a(this.h);
        if (a2 != null) {
            return a2;
        }
    ...
    public Item a(String str, String str2) {
        this.h.a(12, str, str2, (String) null);
        Item a2 = a(this.h);
        if (a2 != null) {
            return a2;
        }
    ...
    public int c(String str) {
        this.g.a(30, str, (String) null, (String) null);
        Item a2 = a(this.g);
        if (a2 == null) {
            a2 = c(this.g);
        }
    ...
    public Item m1069c(String str) {
        this.h.a(16, str, (String) null, (String) null);
        Item a2 = a(this.h);
        if (a2 != null) {
            return a2;
        }
    ...
    public int newUTF8(String str) {
        this.g.a(1, str, (String) null, (String) null);
        Item a2 = a(this.g);
        if (a2 == null) {
    ...
    public byte[] toByteArray() {
        ...
        if (this.c <= 65535) {
            ...
            int i7 = this.k;
            if ((i7 & b.v) != 0 && ((this.b & Settings.DEFAULT_INITIAL_WINDOW_SIZE) < 49 || (i7 & 262144) != 0)) {
                i2++;
                i4 += 6;
                newUTF8("Synthetic");
            }
            ...
            if (attribute != null) {
                ...
                str5 = str6;
                i8 += this.w.a(this, (byte[]) null, 0, -1, -1);
                i2 = a2;
            } else {
                str3 = "Deprecated";
                str2 = "EnclosingMethod";
            ...
            int i9 = this.k;
            byteVector5.putShort(i9 & (~(((i9 & 262144) / 64) | 393216))).putShort(this.l).putShort(this.f45n);
            ...
            int i12 = this.k;
            if ((i12 & b.v) != 0 && ((this.b & Settings.DEFAULT_INITIAL_WINDOW_SIZE) < 49 || (i12 & 262144) != 0)) {
    ...
    public final void visit(int i2, int i3, String str, String str2, String str3, String[] strArr) {
        ...
        this.f45n = str3 == null ? 0 : newClass(str3);
